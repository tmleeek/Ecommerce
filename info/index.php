...
if (isset($_GET['brand'])):
	switch ($_GET['brand']) {
		case 'lund':
			$assign_to_config['site_name']  = 'lund';
			break;

		case 'avs':
			$assign_to_config['site_name']  = 'avs';
			break;
   ...
   $assign_to_config['cp_url'] = 'http://lunddev.build.moe/info/admin.php';
   $assign_to_config['site_url'] = 'http://lunddev.build.moe/info';
