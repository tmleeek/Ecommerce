	...
	public function init()
	{
		...
		*/
		...
		if($this->param('script_tag', TRUE, TRUE))
		{
			...
			<script type="text/javascript" src="https://maps.google.com/maps/api/js?v='.$this->EE->config->item('gmap_api_version').'&sensor='.$sensor.'&amp;key='.$this->EE->config->item('gmap_api_key').'&amp;language='.$lang.'"></script>
