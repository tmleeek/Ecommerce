...
class Gmap_ft extends EE_Fieldtype {
	...
	{	
		...
		$this->EE->theme_loader->javascript('https://maps.google.com/maps/api/js?sensor=true&v='. $this->EE->config->item('gmap_api_version').'&key='.$this->EE->config->item('gmap_api_key'));
