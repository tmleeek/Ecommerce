...
$this->table->add_row(
	form_label( "Language" ) .
	'<div class="subtext">Choose langauge to import these entries as</div>', 
...
$this->table->add_row(
	...
	'<div class="subtext">Select field to identify related entries (ie, the same entry in a different language)</div>', 
