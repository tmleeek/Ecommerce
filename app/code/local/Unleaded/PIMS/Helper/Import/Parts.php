...
class Unleaded_PIMS_Helper_Import_Parts extends Unleaded_PIMS_Helper_Data
{	
	...
	{
		$this->adapter          = Mage::helper('unleaded_pims/import_parts_adapter');
		$this->categoryImporter = Mage::helper('unleaded_pims/import_brands');
	}
	...
	public function saveCurrentProduct()
	{
		...
		if ($isNewProduct)
			$attributeSetId = Mage::helper('unleaded_pims/import_parts_attributesets')->getSetId($this->row, $this->currentSku);
		else
